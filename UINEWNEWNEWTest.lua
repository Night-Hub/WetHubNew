...
--// ========================
--// CUSTOM NOTIFICATION (SQUARE CARD like your mock)
--// ========================
function UILibrary.CallNotification(TitleText, BodyText, Duration, Icon)
	...
	-- === SIZING (edit these if you want bigger/smaller square) ===
	local CARD_W = 240
	local CARD_H = 160
	local HEADER_H = 36
	local CORNER = 22
	local OFFSCREEN_X = CARD_W + 60
	...
	if not Holder then
		...
		Container.Size = UDim2.new(0, CARD_W, 1, -28) -- IMPORTANT: keep container narrow
	...
	-- toast root (this slides)
	local Toast = Instance.new("Frame")
	Toast.Name = "Toast"
	Toast.BackgroundTransparency = 1
	Toast.Size = UDim2.new(0, CARD_W, 0, CARD_H) -- FIXED square-ish size
	...
	Header.BackgroundColor3 = Color3.fromRGB(95, 95, 95)
	Header.Size = UDim2.new(1, 0, 0, HEADER_H)
	Header.Position = UDim2.new(0, 0, 0, 0)
	Header.Parent = Card

	local HeaderCorner = Instance.new("UICorner")
	HeaderCorner.CornerRadius = UDim.new(0, CORNER)
	HeaderCorner.Parent = Header

	-- mask bottom of header so only top corners are rounded
	...
	HeaderBottomMask.Size = UDim2.new(1, 0, 0, CORNER)
	HeaderBottomMask.Position = UDim2.new(0, 0, 1, -CORNER)
	...
	Logo.Position = UDim2.new(0, 18, 0.5, -22)
	Logo.Parent = Body

	-- body text (right of logo)
	...
	BodyLabel.Size = UDim2.new(1, -80, 1, -20)
	BodyLabel.Position = UDim2.new(0, 72, 0, 10)
	BodyLabel.Text = BodyText
	BodyLabel.Parent = Body

	-- slide in/out (right -> in)
	Toast.Position = UDim2.new(0, OFFSCREEN_X, 0, 0)
	...
	task.delay(Duration, function()
		Tween(Toast, { Position = UDim2.new(0, OFFSCREEN_X, 0, 0) })
